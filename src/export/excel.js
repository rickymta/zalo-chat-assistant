 ...
 * trăm sheet mở chậm trên Excel — người dùng nên lọc theo khoảng ngày / chỉ hội thoại đang chờ trả lời.
 */
...
export async function exportExcel({ db, selection, from, to, outDir, accountsById, waitingHours = 2 }) {
  ...
  overview.columns = [
    ...
    { header: 'Tin khách', key: 'inbound', width: 10 },
    { header: 'Tin mình', key: 'outbound', width: 10 },
    { header: 'Tin đầu', key: 'first', width: 20 },
    { header: 'Tin cuối', key: 'last', width: 20 },
    { header: 'Ai nhắn cuối', key: 'lastBy', width: 12 },
    { header: 'Đang chờ trả lời', key: 'waiting', width: 16 },
